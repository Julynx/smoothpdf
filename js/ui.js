...
export function showMessage(msg) {
    ...
    if (elements.messageOverlay) elements.messageOverlay.classList.remove('hidden');
...
export function updateControlsUI() {
    if (elements.pageCountText) elements.pageCountText.textContent = `/ ${state.totalPages}`;
